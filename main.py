...
-- same pattern as Zscaler Connector's / CircleCI Connector's main.py.
"""
...
_LOCAL = (
    "app", "schemas", "cisco_client",
    "handlers_connection", "handlers_umbrella", "handlers_meraki",
    "handlers_bulk_audit",
...
import handlers_umbrella  # noqa: E402,F401
import handlers_meraki  # noqa: E402,F401
